...
def py_ConvertSU2toGMF(MshNam, SolNam, OutNam):
    return _meshutils_module.py_ConvertSU2toGMF(MshNam, SolNam, OutNam)
py_ConvertSU2toGMF = _meshutils_module.py_ConvertSU2toGMF
